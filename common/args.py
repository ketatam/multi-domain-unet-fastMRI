...
class Args(argparse.ArgumentParser):
    ...
    def __init__(self, **overrides):
        ...
        self.add_argument('--standardize', action='store_true',
                          help='If set, perform multi-channel data standardization')
        self.add_argument('--apply-grappa', action='store_true',
                          help='If set, perform GRAPPA preprocessing on data')
